...
public class LexicalAnalyzer {
    ...
    public LexicalAnalyzer(String inputText) {
        ...
        keywordsAndTokens.put("LIKE", Token.LIKE);
        ...
        keywordsAndTokens.put("+=", Token.PLUS_EQUALS);
        keywordsAndTokens.put("-=", Token.SUB_EQUALS);
        keywordsAndTokens.put("*=", Token.MUL_EQUALS);
        keywordsAndTokens.put("/=", Token.DIV_EQUALS);
        keywordsAndTokens.put("CLIENTES", Token.CLIENTES);
        keywordsAndTokens.put("IDCLIENTE", Token.IDCLIENTE);
